...
const statisticsConfig: Record<QueueStatistics, { label: string; subClass: string }> = {
    queue_pending: { label: "Kutilmoqda", subClass: "text-blue-500" },
    queue_approved: { label: "Tasdiqlandi", subClass: "text-emerald-500" },
    queue_payment_uploaded: { label: "To‘lov yuklandi", subClass: "text-yellow-500" },
    queue_payment_approved: { label: "Hujjat yuklanmagan", subClass: "text-orange-500" },
    queue_rejected: { label: "Rad etildi", subClass: "text-red-500" },
};
